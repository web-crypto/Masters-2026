...
_NORMALIZED_NAME_ALIASES = {
    "sunjae im": "sungjae im",
}
...
def normalize_name(name: str) -> str:
    ...
    normalized = ascii_str.lower().strip().translate(_CHAR_MAP)
    return _NORMALIZED_NAME_ALIASES.get(normalized, normalized)
